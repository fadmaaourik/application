...
import video from '../images/EPI_3.mp4';
function SousChoix3() {
  const navigate = useNavigate();

  const handleProceedClick = () => {
    navigate("/Maintenance_corrective/Porte_d'accès_voyageurs/Porte_non_verrouillée_EPI_3/question1");
  };
