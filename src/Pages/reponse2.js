...
function Response2() {
  ...
  const deregleclick = ()=>{
    navigate("/Maintenance_corrective/Porte_d'accès_voyageurs/Porte_non_verrouillée_EPI_3/question1/reponse1/rep2");
  }
    ...
    <div className="background">
      ...
      <div className="back2">
        ...
        <img src={icone2} alt="Logo3" className='logo2'/>
          <div className='choisir'> Checker le réglage de la serrure </div>
